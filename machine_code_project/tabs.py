...
from architecture_config import ArchitectureConfigWidget
...
class CodeGenerationTab(QWidget):
    ...
    def generate_code(self):
        # Здесь должна быть логика генерации кода с использованием модели.
        self.gen_output.setText("Сгенерированный код...")
