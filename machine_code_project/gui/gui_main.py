...
from machine_code_project.gui.tabs import CodeGenerationTab, TrainingTab, FineTuningTab, FileConverterTab, WebParserTab, RepoClonerTab
...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        from machine_code_project.gui.tabs import CodeGenerationTab, TrainingTab, FineTuningTab, FileConverterTab, WebParserTab, RepoClonerTab
        self.tabs.addTab(CodeGenerationTab(), "Генерация")
        self.tabs.addTab(TrainingTab(), "Обучение")
        self.tabs.addTab(FineTuningTab(), "Дообучение")
        self.tabs.addTab(FileConverterTab(), "Конвертер")
        self.tabs.addTab(WebParserTab(), "Парсер")
        self.tabs.addTab(RepoClonerTab(), "Клонирование")
